...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi, welcome to my Blog🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Supercarrych', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'student🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://supercarrych.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ad, blog', // 网站关键词 英文逗号隔开
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-6936277554834045', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
